...
module.exports = class {
  constructor(localStore, debug) {
    ...
    this.language	= 'eng'			//Current language
...
if (error) this.debug("Error:", error, errView, code, cache)
...
//this.debug("Now have:", error, errView, code, cache)
...
this.debug("Request ID:", id, "Action:", action, "Opt", JSON.stringify(opt), !!this.sender)
...
this.debug("Write to backend:", "Data:" + JSON.stringify(msg))
    if (this.sender)
