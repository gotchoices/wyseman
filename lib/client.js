...
this.log.trace("Generated key:", user, keyPair.privateKey)
      if (this.keyCB) this.keyCB(			//Let the caller store the new key
        {login: {host, port, user, key:exPriv}}
      )
...
this.log.trace("Public:", exPub)
    ...
    if (!key) throw "Must specify a token or a key"
